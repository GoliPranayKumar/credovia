    ...
    <div className="min-h-[70vh] flex items-center justify-center">
      ...
      >
        <div className="text-center space-y-2">
          <div className="w-16 h-16 bg-gradient-to-br from-violet-600 to-cyan-500 rounded-2xl flex items-center justify-center mx-auto shadow-xl shadow-violet-500/15 mb-4">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="flex flex-col gap-3">
            <button 
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-violet-600 to-cyan-500 hover:from-violet-700 hover:to-cyan-600 text-white font-bold py-4 rounded-2xl shadow-lg shadow-violet-500/15 transition-all active:scale-95 flex items-center justify-center gap-2"
            >
        ...
        <p className="text-center text-muted-foreground">
          Don't have an account? <Link href="/signup" className="text-violet-600 font-bold hover:underline">Sign up</Link>
        </p>
      </motion.div>

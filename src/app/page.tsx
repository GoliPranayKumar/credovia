    ...
    <div className="space-y-32">
      ...
      <section className="relative pt-12 text-center space-y-8">
        ...
        >
          <Link 
            href="/login" 
            className="w-full sm:w-auto px-8 py-4 bg-primary text-white font-bold rounded-2xl shadow-xl shadow-primary/30 hover:shadow-primary/40 transition-all hover:-translate-y-1 active:scale-95 text-lg"
          >
            Create Your Profile
          </Link>
          <Link 
            href="/search" 
            className="w-full sm:w-auto px-8 py-4 bg-secondary border border-white/10 text-white font-bold rounded-2xl hover:bg-secondary/80 transition-all hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-2 text-lg"
          >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-10 w-full max-w-4xl opacity-20 blur-3xl pointer-events-none">
          ...
          <div className="absolute bottom-0 right-1/4 w-72 h-72 bg-purple-600 rounded-full" />
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <motion.div 
            ...
            className="p-8 rounded-3xl glass hover:border-white/20 transition-colors space-y-4"
          >
            <div className={`w-12 h-12 bg-secondary rounded-xl flex items-center justify-center ${f.color} border border-white/5 shadow-inner`}>
      ...
      {/* Trust Logos */}
      <section className="text-center py-20 border-y border-white/5 space-y-12">
